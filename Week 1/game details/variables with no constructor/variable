public class App {
    public static void main(String[] args) {
        ...
        // - comments ibig sabihin nan

        //these are the code (yung nasa baba)

        // VARIABLES
        String petName = "Juana";
        ...
        boolean iAmAmusician = true;
        boolean iAmFamous = false;

        // String - stores text, such as "Hello". String values are surrounded by double
        // quotes
        String myFirstName = "John Darrel";
        ...
        final String myLastName = "Poquiz";

        System.out.println(petName);
        System.out.println(myAge);
        System.out.println(myGradeInClass);
        System.out.println(myMiddleInitial);
        System.out.println(iAmAmusician);
        System.out.println(iAmFamous);
